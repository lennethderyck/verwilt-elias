    ...
    <Layout navigation={navigation} settings={settings}>
      ...
      <main className={styles["about-container"]}>
        ...
        <div className={styles["about-image"]}>
          <PrismicNextImage field={settings?.data.image} alt="" />
        </div>
        <div className={styles["about-details"]}>
          <p className={styles["about-details-description"]}>
            <PrismicText field={about.data.description} />
          </p>
            ...
            <form ref={form} onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className={styles["contact-form-box"]}>
                <div className={styles["contact-form-box-input"]}>
                  <div className={styles["contact-form-box-input-name"]}>
              ...
              <div className={styles["contact-form-textarea"]}>
